          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {repos.map((repo) => (
              <a
                ...
                className="hover-lift group block p-6 rounded-2xl bg-background border border-border"
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <svg className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                  </svg>
                </div>

                <h3 className="font-heading font-semibold text-foreground mt-4 text-base">
                  {repo.name.replace(/-/g, " ")}
                </h3>
