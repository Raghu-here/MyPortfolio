        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="animated-underline text-sm font-medium text-muted-foreground hover:text-foreground transition-colors pb-0.5"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="hidden md:flex items-center gap-3">
          {socialLinks.map((link) => (
            <a
              ...
              className="icon-hover text-muted-foreground hover:text-primary"
