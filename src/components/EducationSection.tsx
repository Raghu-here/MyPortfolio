        ...
        <div className="mt-12 max-w-2xl mx-auto">
          <div className="p-8 sm:p-10 rounded-2xl bg-background border border-border hover-lift" style={{ boxShadow: 'var(--shadow-card)' }}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl shrink-0" style={{ background: 'var(--gradient-accent)' }}>
                ...
                <div className="mt-6 p-4 rounded-xl bg-muted border border-border">
                  ...
                  <div className="mt-3 h-2 rounded-full bg-border overflow-hidden">
                    <div
                      ...
                      style={{ width: "88%", background: 'var(--gradient-accent)' }}
                    />
                  </div>
                </div>
              </div>
